...
* If not, see <http://www.gnu.org/licenses/>.
	...
	Minor rework of the code.
	- Changed a few of the variable types to reduce computational
	  requirements with a small loss of precision.
	- Added calculatin of antipodal pairs for the rotating 
	  calipers algorithm (does not work!).
